...
const ROLE_NAV: Record<StaffRole, string[]> = {
  ...
  sales: ['dashboard', 'reports', 'profile', 'teachers', 'parents', 'students', 'enrollments', 'discount-codes', 'classes', 'documents', 'wishlist-activity'],
  marketing: ['dashboard', 'reports', 'profile', 'teachers', 'parents', 'students', 'cms-pages', 'website-settings', 'contact-submissions', 'notification-templates', 'documents', 'wishlist-activity'],
