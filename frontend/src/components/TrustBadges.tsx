/**
 * Trust badges (DPDP, BGV, secure payments, etc.) for use across the app.
 */
...
export function TrustBadges({ variant = 'inline', className = '' }: TrustBadgesProps) {
  ...
  if (variant === 'section') {
    return (
      <div className={`rounded-2xl border-2 border-brand-100 bg-gradient-to-br from-brand-50/80 via-white to-brand-100 p-6 shadow-sm sm:p-8 ${className}`}>
        <h3 className="text-center text-lg font-bold text-brand-900 sm:text-xl">
          Trusted & Secure
        </h3>
