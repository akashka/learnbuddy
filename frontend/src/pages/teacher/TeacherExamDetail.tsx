      ...
      <div className="mb-6 rounded-xl border border-brand-200 bg-white p-6">
        ...
        {feedback?.lowSentimentWarning && (
          <div className="mt-4 rounded-lg border border-amber-300 bg-amber-50 p-3 text-sm text-amber-800">
            ⚠️ Some content in the student&apos;s answers was automatically masked for inappropriate language.
          </div>
        )}
        {feedback && (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="mx-4 max-w-md rounded-xl bg-white p-6 shadow-lg">
            ...
            <p className="mb-4 text-sm text-gray-600">
              ...
              Please explain your concern (at least 10 characters).
            </p>
            {submitSuccess ? (
              <div className="rounded-lg bg-green-50 p-4 text-green-800">
                Your review request has been submitted. Track status in &quot;Review Requests&quot;.
              </div>
            ) : (
