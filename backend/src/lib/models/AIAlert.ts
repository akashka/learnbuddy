...
export type AlertType = 'face_mismatch' | 'camera_off' | 'voice_off' | 'absent' | 'background_noise' | 'extra_person' | 'foul_language' | 'other';
...
const AIAlertSchema = new Schema<IAIAlert>(
  {
    ...
    type: { type: String, enum: ['face_mismatch', 'camera_off', 'voice_off', 'absent', 'background_noise', 'extra_person', 'foul_language', 'other'] },
