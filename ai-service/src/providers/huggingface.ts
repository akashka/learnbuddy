 ...
 * Free tier: ~300 req/hour, $0.10/month credits. Many models (Llama, Qwen, Gemma).
...
// Chat models - meta-llama/Llama-3.3-70B-Instruct is on Groq. Override via HF_MODEL env.
